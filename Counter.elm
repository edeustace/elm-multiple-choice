...
import Common exposing(Msg(Increase,Reset, Mdl)) 
import Radio exposing(otherRadio)
-- where
...
radio : Material.Model -> Msg -> Html Msg
radio model msg =
  div []
  [
    Toggles.radio Mdl [0] model 
          [ Toggles.value True 
...
view model =
    div
        ...
        , Button.render Mdl
            ...
            [ text "Reset" ]
        , otherRadio model.mdl Increase "one" True
        , otherRadio model.mdl Increase "two" False
        ]
        |> Material.Scheme.top
